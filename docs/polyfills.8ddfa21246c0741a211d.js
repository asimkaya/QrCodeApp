    ...
    'N/DB': function (e, t) {
      const n = 'undefined' != typeof globalThis && globalThis,
        ...
        i = function (e, ...t) {
          ...
          let n = a(e[0], e.raw[0]);
          for (let o = 1; o < e.length; o++) n += t[o - 1] + a(e[o], e.raw[o]);
          return n;
        };
      function a(e, t) {
        return ':' === t.charAt(0)
        ...
        (r =
          ...
          typeof (o = function () {
            ...
            !(function (e) {
              ...
              class a {
                  ...
                  try {
                    ...
                    e.state !== v &&
                      ...
                      (e.type == P || (e.data && e.data.isPeriodic)
                        ? o && e._transitionTo(T, w)
                        : ((e.runCount = 0), this._updateTaskCount(e, -1), o && e._transitionTo(v, w, v))),
                      (O = O.parent),
                      (j = r);
                  }
                }
                scheduleTask(e) {
                  ...
                  return (
                    e._zoneDelegates === t && this._updateTaskCount(e, 1), e.state == b && e._transitionTo(T, b), e
                  );
                }
              ...
              Zone.__load_patch('ZoneAwarePromise', (e, t, n) => {
                ...
                function Z(e, o, s) {
                  ...
                  if (e[g] === v) {
                    ...
                    if (o !== T && s instanceof C && s.hasOwnProperty(g) && s.hasOwnProperty(k) && s[g] !== v)
                      D(s), Z(e, s[g], s[k]);
                ...
                class C {
                  ...
                  then(e, n) {
                    ...
                    const r = new o(z),
                      s = t.current;
                    return this[g] == v ? this[k].push(s, r, e, n) : P(this, s, r, e, n), r;
                  }
                  catch(e) {
                    ...
                    o[_] = _;
                    const r = t.current;
                    return this[g] == v ? this[k].push(r, o, e, e) : P(this, r, o, e, e), o;
                  }
                }
                ...
                (I && !I.configurable) ||
                  ...
                  (I.set = function (t) {
                    t === C ? (e[j] = t) : ((e[c] = t), t.prototype[l] || R(t), n.setNativePromise(t));
                  }),
                  r(e, 'Promise', I)),
                  (e.Promise = C);
            ...
            const d = Zone.__symbol__,
              ...
              k = g ? window : void 0,
              _ = (g && k) || ('object' == typeof self && self) || global,
              m = [null];
            function y(e, t) {
            ...
            const b = 'undefined' != typeof WorkerGlobalScope && self instanceof WorkerGlobalScope,
              T = !('nw' in _) && void 0 !== _.process && '[object process]' === {}.toString.call(_.process),
              w = !T && !b && !(!g || !k.HTMLElement),
              E =
                void 0 !== _.process &&
            ...
            function C(e) {
              ...
              for (r in o)
                ('XMLHttpRequest' === e && 'responseBlob' === r) ||
                  (function (n) {
                    'function' == typeof o[n]
                      ? (_[e].prototype[n] = function () {
                          return this[z][n].apply(this[z], arguments);
                        })
                      : t(_[e].prototype, n, {
                          set: function (t) {
                            'function' == typeof t
                              ? ((this[z][n] = p(t, e + '.' + n)), I(this[z][n], t))
                              : (this[z][n] = t);
                          },
                          get: function () {
                            return this[z][n];
            ...
            function q(e, t, o) {
              const r = (o && o.add) || s,
                ...
                k = function (e, t, n) {
                  ...
                  r &&
                    'object' == typeof r &&
                    r.once &&
                    t[a].call(t, n.type, e.originalDelegate ? e.originalDelegate : e.callback, r);
                },
                _ = function (t) {
                  ...
                  const n = this || t.target || e,
                    o = n[H[t.type].false];
                  if (o)
                    if (1 === o.length) k(o[0], n, t);
                    else {
                      const e = o.slice();
                      for (let o = 0; o < e.length && (!t || !0 !== t[B]); o++) k(e[o], n, t);
                    }
                },
                m = function (t) {
                  if (!(t = t || e.event)) return;
              ...
              function y(t, o) {
                ...
                const C = s
                    ? function (e) {
                        if (!w.isExisting) return E.call(w.target, w.eventName, w.capture ? m : _, w.options);
                      }
                    : function (e) {
                        return E.call(w.target, w.eventName, e.invoke, w.options);
                      },
                  O = s
                    ? function (e) {
                        if (!e.isRemoved) {
                        ...
                        if (e.allRemoved) return Z.call(e.target, e.eventName, e.capture ? m : _, e.options);
                      }
                    : function (e) {
                  ...
                  x = function (t, n, r, a, c = !1, h = !1) {
                    return function () {
                      ...
                      const _ = L && !!R && -1 !== R.indexOf(f),
                        m = z(arguments[2], _);
                      if (N)
                        for (let e = 0; e < N.length; e++)
                          if (f === N[e]) return _ ? t.call(p, f, d, m) : t.apply(this, arguments);
                      ...
                      let D,
                        ...
                        C = !1;
                      if (P) {
                        if (((C = !0), k)) for (let e = 0; e < P.length; e++) if (j(P[e], d)) return;
                      } else P = p[S] = [];
                      ...
                      const x = s ? A : void 0;
                      x && (x.taskData = w);
                      const M = E.scheduleEventTask(D, d, x, r, a);
                      return (
                        (w.target = null),
                        x && (x.taskData = null),
                        v && (m.once = !0),
                ...
                return (
                  ...
                  P &&
                    (v.prependListener = x(
                      ...
                      '.prependListener:',
                      function (e) {
                        return P.call(w.target, w.eventName, e.invoke, w.options);
                      },
                      O,
                      y,
                      !0
            ...
            Zone.__load_patch('util', (n, a, c) => {
              (c.patchOnProperties = P), (c.patchMethod = O), (c.bindArguments = y), (c.patchMacroTask = j);
                  ...
                  (n.args[0] = function () {
                    try {
                      ...
                      (t.data && t.data.isPeriodic) ||
                        ('number' == typeof n.handleId ? delete i[n.handleId] : n.handleId && (n.handleId[ce] = null));
                    }
                  }),
                      ...
                      'number' == typeof r ? (s = i[r]) : ((s = r && r[ce]), s || (s = r)),
                        s && 'string' == typeof s.type
                          ? 'notScheduled' !== s.state &&
                            ...
                            ('number' == typeof r ? delete i[r] : r && (r[ce] = null), s.zone.cancelTask(s))
                          : t.apply(e, o);
                    }
                ));
            }
              ...
              Zone.__load_patch('XHR', (e, t) => {
                !(function (e) {
                  ...
                  function m(e) {
                    ...
                    (i[s] = !1), (i[l] = !1);
                    const u = i[r];
                    p || ((p = i[a]), (g = i[c])), u && g.call(i, k, u);
                    const h = (i[r] = () => {
                      if (i.readyState === i.DONE)
                        if (!o.aborted && i[s] && e.state === _) {
                          ...
                          if (n && n.length > 0) {
                            ...
                            (e.invoke = function () {
                              ...
                              o.aborted || e.state !== _ || r.call(e);
                            }),
                              n.push(e);
                          } else e.invoke();
                        } else o.aborted || !1 !== i[s] || (i[l] = !0);
                    });
                    return p.call(i, k, h), i[n] || (i[n] = e), E.apply(i, o.args), (i[s] = !0), e;
                  }
                  function y() {}
                  function v(e) {
                    const t = e.data;
                      ...
                      () =>
                        function (e, n) {
                          ...
                          if (e[o]) return E.apply(e, n);
                          {
                            ...
                            e && !0 === e[l] && !t.aborted && o.state === _ && o.invoke();
                          }
                        }
                    ),
                    Z = O(
